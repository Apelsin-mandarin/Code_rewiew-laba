...
public class UserInput {
  ...
  // FIXME: Использование табуляции вместо пробелов и отсутствие пробелов в условиях
  /*
  ...
  */
  ...
  // FIXME: Сложная логика вложений и нарушение отступов
  /*
  public int inputRangeInt(int start, int end, String what){
  ...
  */
  ...
  public int inputRangeInt(int start, int end, String what) {
    ...
    while (true) {
      ...
      System.out.println("Некорректный ввод! Диапазон от " + start + " до " + end + "!");
      System.out.println("Введите " + what + " от " + start + " до " + end + ": ");
      input = scanner.nextLine();
    }
  }
